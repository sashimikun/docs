...
- Monthly usage (10 repos): ~$35/month
</Accordion>
...
2. **Standard projects:** Use gpt-4o for best balance
3. **Complex analysis:** Use o1 series for deep insights
...
```javascript
{
  "auto_model_selection": {
    "repository_size": {
      ...
      "medium": "gpt-4o",      // 100-1000 files  
      "large": "gpt-4o"        // 1000+ files
    },
    "complexity_factors": [
      "multiple_languages",
